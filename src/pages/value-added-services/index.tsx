    ...
    <Layout>
      ...
      <div className="back-wall">
        <div className="container cover">
          <NavBar />
          <h1 className="heading">Managed<br/> valued added Services</h1>
          <h1 className="heading-last">for Enterprises</h1>
        </div>
        <div className="container service">
          <p className="title">
            Our co-location service allows you to house server infrastructure in
            our Colombo facility in the heart of business district. Our data
            center is built to the global standards using world class
            infrastructure technologies meeting the robust functionality of TIA
            942 Rated 03 data center standards
          </p>
